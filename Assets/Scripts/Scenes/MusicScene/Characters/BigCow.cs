...
public class BigCow : MonoBehaviour
{
    ...
    {
        transform.DOScale(targetScale, duration * 1.5f).From(initialScale).SetDelay(0.4f);
    }
    private void OnMouseDown()
    {
        if (timeToClick <= 0)
        {
            ...
            soundSystem.PlaySound("isCowSound");
            animator.SetTrigger("isCowAnim");
