...
public class YellowChicken : MonoBehaviour
{
    ...
    {
        transform.DOScale(targetScale, duration * 1.5f).From(initialScale).SetDelay(1.1f);
    }
    private void OnMouseDown()
    {
        if (timeToClick <= 0)
        {
            ...
            soundSystem.PlaySound("isChickenSound");
            animator.SetTrigger("isChickenAnim");
